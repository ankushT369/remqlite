...
#
TOP = /media/ankush/backupdog/projects/sqlite-src-3510300
...
#
OPT_FEATURE_FLAGS = -DSQLITE_ENABLE_MATH_FUNCTIONS -DSQLITE_ENABLE_PERCENTILE -DSQLITE_THREADSAFE=1 $(OPTIONS) 

#
# Version (X.Y.Z) number for the SQLite being compiled.
#
PACKAGE_VERSION = 3.51.3
...
#
AS_AUTORECONFIG = cd "/media/ankush/backupdog/projects/sqlite-src-3510300" && ./configure
